...
//	'offen' => array('常用', '', '', '', ''),
	...
	'u_point' => array('用户积分管理', 'wap/Point/*', '', '', 'u'),
	'u_point_count' => array('积分统计', 'wap/PointCount/*', '', '', 'u'),
	'u_header_check' => array('头像审核', 'wap/UserHeader/*', '', '', 'u'),
	'u_gift_exend' => array('用户礼包发放', 'wap/GiftExend/*', '', '', 'u'),
	...
	'wap_add_thread' => array('发帖', 'wap/ForumNew/*', '', '', 'contents'),
	'bbs_managecount' => array('管理统计', 'bbs/managecount/*', '', '', 'contents'),
