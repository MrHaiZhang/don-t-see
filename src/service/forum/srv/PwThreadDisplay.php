...
class PwThreadDisplay extends PwBaseHookService {
	...
	public $hit = true;		//是否增加点击量
	public $shield = true;		//是否屏蔽用户禁言内容
	...
	public function __construct($tid, PwUserBo $user, $hit = true, $shield = true) {
	...
	public function bulidRead($read, $lou) {
		...
		} elseif ($this->users[$read['created_userid']]['groupid'] == '6' && $this->shield) {
