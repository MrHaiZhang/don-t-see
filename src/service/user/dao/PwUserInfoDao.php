...
class PwUserInfoDao extends PwBaseDao {
	...
	protected $_pk = 'uid';
	protected $_dataStruct = array('uid', 'gender','byear', 'bmonth', 'bday', 'location', 'location_text', 'hometown', 'hometown_text', 'homepage', 'qq', 'msn', 'aliww', 'mobile', 'alipay', 'bbs_sign', 'profile', 'regreason', 'telphone', 'address', 'zipcode', 'secret', 'nickname', 'sensitive', 'headcheck');
