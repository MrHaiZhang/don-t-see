 ...
 *
 * 增加是否是官网用户的字段off_user,唯一十位数字字段ident_id
 * 增加用户打卡总数
 */
class PwUserInfoDm extends PwBaseDm {
	 ...
	 * @return PwUserInfoDm
	 */
	public function setOffuser($off_user) {
		$this->getDm()->setOffuser($off_user);
		$this->_data['off_user'] = $off_user;
		return $this;
	}
	 ...
	 * @return PwUserInfoDm
	 */
	public function setIdentId($ident_id) {
		$this->getDm()->setIdentId($ident_id);
		$this->_data['ident_id'] = $ident_id;
		return $this;
	}
	 ...
	 * @return PwUserInfoDm
	 */
	public function setPunchNum($num) {
		$this->_data['punch_num'] = intval($num);
		return $this;
	}
	...
	public function setSensitive($sensitive) {
		$this->_data['sensitive'] = $sensitive;
		return $this;
	}
	 ...
	 * @param string $nickname
	 */
	public function setHeadcheck($headcheck) {
		$this->_data['headcheck'] = $headcheck;
		return $this;
	}
