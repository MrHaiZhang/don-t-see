...
<div class="table_full">
	<table width="100%">
		...
		<tr>
			<th>官网后台地址</th>
			<td>
				<input name="infoOffWeb" type="text" class="input length_5" value="<?php echo htmlspecialchars($config['info.offweb'], ENT_QUOTES, 'UTF-8');?>">
			</td>
			<td><div class="fun_tips">填写官网后台的完整域名。例如: http://127.0.0.1/qdazzle_home/admin，不要以斜杠 (“/”) 结尾</div></td>
		</tr>
		<tr>
			<th>官网地址</th>
			<td>
				<input name="infoAppWeb" type="text" class="input length_5" value="<?php echo htmlspecialchars($config['info.appweb'], ENT_QUOTES, 'UTF-8');?>">
			</td>
			<td><div class="fun_tips">填写官网的完整域名。例如: http://127.0.0.1/qdazzle_home/app，不要以斜杠 (“/”) 结尾</div></td>
		</tr>
		<tr>
			<th>官网手机地址</th>
			<td>
				<input name="infoMobWeb" type="text" class="input length_5" value="<?php echo htmlspecialchars($config['info.mobweb'], ENT_QUOTES, 'UTF-8');?>">
			</td>
			<td><div class="fun_tips">填写官网手机的完整域名。例如: http://127.0.0.1/qdazzle_home/mobile，不要以斜杠 (“/”) 结尾</div></td>
		</tr>
		<tr>
			<th>管理员电子邮箱</th>
			<td>
