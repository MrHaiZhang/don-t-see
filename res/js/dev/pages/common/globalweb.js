 ...
 * 全局公共方法
*/
var glo_text_node = null;

function setTextNode(){
    glo_text_node = window.getSelection ? window.getSelection() : document.selection.createRange();
}

function insertTextAtCursor(obj, content) {
    var sel, range;
...
(function () {
	...
	if(insert_emotions.length && !DESIGN_MODE) {
		Wind.js(GV.JS_ROOT+ 'pages/common/insertEmotionsweb.js?v='+ GV.JS_VERSION, function(){
